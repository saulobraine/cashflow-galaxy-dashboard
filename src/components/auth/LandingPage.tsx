      ...
      <div className="container mx-auto px-4 pt-28 pb-8">
        ...
        <div className="text-center mb-24 animate-fade-in">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl md:text-7xl font-bold mb-8 bg-gradient-to-r from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent leading-tight animate-scale-in">
              Transforme suas Finanças
            </h2>
            <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in [animation-delay:0.2s]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              {stats.map((stat, index) => (
                <div key={index} className="flex flex-col items-center space-y-2 p-6 rounded-lg bg-card/50 backdrop-blur border border-border/50 hover-scale animate-fade-in" style={{ animationDelay: `${0.4 + index * 0.1}s` }}>
          ...
          {/* Call to Action Card */}
          <Card className="max-w-md mx-auto shadow-xl border border-primary/20 bg-card/80 backdrop-blur-sm animate-scale-in">
        ...
        <div className="mb-24 animate-fade-in">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center mb-16">
            ...
            <div className="relative animate-scale-in">
              <Card className="p-6 bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20 hover-scale">
        ...
        <div className="mb-24 animate-fade-in">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="text-center p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-primary/10 hover:border-primary/30 animate-fade-in hover-scale" style={{ animationDelay: `${index * 0.1}s` }}>
        ...
        <div className="text-center mb-16 animate-scale-in">
          <Card className="max-w-4xl mx-auto p-12 bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5 border-primary/20 hover-scale">
