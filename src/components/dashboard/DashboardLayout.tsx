            ...
            {sharedAccounts.map((account) => (
              <div
                ...
                className={`p-3 rounded-lg border cursor-pointer transition-colors ${
                  account.active ? 'bg-primary/10 border-primary' : 'hover:bg-muted'
                }`}
              >
                <div className="flex items-center justify-between">
                  <div>
            ...
            <div className="space-y-3">
              ...
              <Card className="p-3 bg-background/60">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <p className="font-medium text-sm">{sharedAccountInfo.name}</p>
                    <Badge variant="secondary" className="text-xs">{sharedAccountInfo.plan}</Badge>
                  </div>
                  <p className="text-xs text-muted-foreground">{sharedAccountInfo.role}</p>
            ...
            <Tooltip>
              ...
              <TooltipContent side="right">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">{sharedAccountInfo.name}</p>
                </div>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
...
const AppSidebar = () => {
  ...
  return (
    <TooltipProvider>
      <Sidebar collapsible="icon" className={`${isCollapsed ? "w-14" : "w-60"} flex flex-col`}>
